    ...
    return {
        ...
        get factionData() {
            ...
            return this.alliances.map(a => {
                ...
                // If before season start, stash doesn't grow until Jan 5 03:00
                const effectiveNow = cetNow < this.seasonStart ? this.seasonStart : cetNow;
                
                const hoursSinceScout = Math.max(0, (effectiveNow - scoutTime) / 3600000);
                const hoursUntilWar = Math.max(0, (warTime - effectiveNow) / 3600000);
        ...
        getNextWarTime() {
            ...
            // If we are currently before the season start, the first war is the first Wed/Sat after Jan 5
            ...
            while (safety < 14) {
                ...
                if ((day === 3 || day === 6) && target > startPoint) {
                    return target;
                }
...
${this.importData}`;
        ...
        async processImport() {
            ...
            try {
                ...
                this.importData = '';
            } catch (e) { alert("Error: Use AI prompt first."); }
